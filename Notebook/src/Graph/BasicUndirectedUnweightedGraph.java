 ...
 */
public class BasicUndirectedUnweightedGraph
{
    // Attributes
    ...
    public static class Search
    {
         ...
         */
        public Search(BasicUndirectedUnweightedGraph pGraph, int pOrigin)
        {
    ...
    public static class BasicDFS extends Search
    {
         ...
         */
        public BasicDFS(BasicUndirectedUnweightedGraph pGraph, int pOrigin)
        {
         ...
         */
        private void basicDFS(BasicUndirectedUnweightedGraph pGraph, int pVertex)
        {
            marked[pVertex] = true;
    ...
    public static class BasicBFS extends Search
    {
         ...
         * @param pOrigin Vertex from which the search starts.
         */
        public BasicBFS(BasicUndirectedUnweightedGraph pGraph, int pOrigin)
        {
            super(pGraph, pOrigin);
         ...
         * @param pVertex Vertex from which the search starts.
         */
        private void basicBFS(BasicUndirectedUnweightedGraph pGraph, int pVertex)
        {
