...
public class BasicUndirectedUnweightedALCCGraph extends BasicUndirectedUnweightedALGraph
{
    // Attributes
    ...
    /**
     * Creates a BasicUndirectedUnweightedALCCGraph object with N vertices labeled from 0 to N.
     * @param N The number of vertices to add to the graph.
     */
    public BasicUndirectedUnweightedALCCGraph(int N)
    {
        super(N);
    ...
    /**
     * Creates a BasicUndirectedUnweightedALCCGraph object copy of the given graph.
     * @param pGraph The graph to copy.
     */
    public BasicUndirectedUnweightedALCCGraph(BasicUndirectedUnweightedALCCGraph pGraph)
    {
        super(pGraph);
