...
public class BasicUndirectedUnweightedALGraph implements IBasicGraph
{
    // Attributes
    ...
    /**
     * Creates a BasicUndirectedUnweightedALGraph object with N vertices labeled from 0 to N-1.
     * @param N The number of vertices to add to the graph.
     */
    public BasicUndirectedUnweightedALGraph(int N)
    {
        V = N;
        E = 0;
    ...
    /**
     * Creates a BasicUndirectedUnweightedALGraph object copy of the given graph.
     * @param pGraph The graph to copy.
     */
    public BasicUndirectedUnweightedALGraph(BasicUndirectedUnweightedALGraph pGraph)
    {
        this.V = pGraph.V;
        this.E = pGraph.E;
